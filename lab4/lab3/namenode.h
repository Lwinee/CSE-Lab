...
private:
 ...
 struct DataNodeInfo{
    ...
    std::set<blockid_t> written_blocks;
  };
  std::map<DatanodeIDProto,NameNode::DataNodeInfo> DataNodeList;
  std::list<DatanodeIDProto> LiveList;
...
private:
  ...
  void Monitor(DatanodeIDProto id);
  void Replicate_Block(DatanodeIDProto id);
public:
